...
function porco-help {
    ...
    echo -e "  \e[1;36mYOUTUBE (se falhar 429)\e[0m"
    echo -e "  arquivo \e[1;32m~/porco-music-bot/youtube-cookies.txt\e[0m (cookies Netscape) + \e[1;32msystemctl --user restart porco.service\e[0m"
    echo -e ""
